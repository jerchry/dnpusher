...
public class AudioChannel {
    ...
    public AudioChannel(LivePusher livePusher) {
        ...
        //最小需要的缓冲区
//        参考：
//        android.media.AudioRecord.AudioRecord(int, int, int, int, int)
        // why *2?
        // Note that this size doesn't guarantee a smooth recording under load,
        // and higher values should be chosen according to the expected frequency at which the AudioRecord instance will be polled for new data.
        ...
        //1s采样的总数据量大小=44100*16位/8
        audioRecord = new AudioRecord(MediaRecorder.AudioSource.MIC, 44100, channelConfig,
//                AudioFormat.ENCODING_PCM_16BIT, minBufferSize > inputSamples ? minBufferSize : inputSamples);
